...
@ObjectType()
export class CourseReviewSubmitRatingGqlResponse {
...
@ObjectType()
export class CourseReviewSubmitGqlResponse {
  @Field(() => ID, { description: "Course review thread ID" })
  id: Types.ObjectId;

  @Field(() => ID, { description: "Reviewed course ID" })
  ...
  @Field(() => CourseReviewSubmitRatingGqlResponse, {
    nullable: true,
    description: "Submitted rating, if any",
  })
  rating?: CourseReviewSubmitRatingGqlResponse;
