...
import { CourseReviewSubmitMutation, CourseReviewModerationUpdateMutation } from "./graphql/mutations";
import { CourseReviewListQuery, UserCourseReviewListQuery } from "./graphql/queries";
