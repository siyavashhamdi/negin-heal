...
import { PaymentCouponListSortOptionInput } from "./payment-coupon-list-sort-option.gql.input";

@InputType()
export class PaymentCouponListFilterInput {
  @Field({
    nullable: true,
...
@InputType()
export class PaymentCouponListOffsetPageOptionsParamsInput extends OffsetPageOptionsParamsInput {
  @Field(() => PaymentCouponListSortOptionInput, {
    nullable: true,
    description: "Sort options as a map of field names to sort order",
  })
  @IsOptional()
  @ValidateNested()
  @Type(() => PaymentCouponListSortOptionInput)
  sort?: PaymentCouponListSortOptionInput;
}

@InputType()
export class PaymentCouponListGqlInput extends PaginationOffsetInput<PaymentCouponListFilterInput> {
  @Field(() => PaymentCouponListFilterInput, {
    nullable: true,
    description: "Filter options for narrowing down the payment coupon list",
  })
  @IsOptional()
  @ValidateNested()
  @Type(() => PaymentCouponListFilterInput)
  filters?: PaymentCouponListFilterInput;

  @Field(() => PaymentCouponListOffsetPageOptionsParamsInput, {
    nullable: true,
    description: "Offset pagination and sorting options",
  })
  @IsOptional()
  @ValidateNested()
  @Type(() => PaymentCouponListOffsetPageOptionsParamsInput)
  options?: PaymentCouponListOffsetPageOptionsParamsInput;
}
