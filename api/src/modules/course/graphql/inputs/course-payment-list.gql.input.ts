...
@InputType()
export class CoursePaymentListFilterInput {
  @Field({
    nullable: true,
    description:
  ...
  @Field(() => ID, {
    nullable: true,
    description: "Filter by user-course purchase record ID",
  })
  @IsOptional()
  ...
  @Field(() => ID, {
    nullable: true,
    description: "Filter payments by course ID",
  })
  @IsOptional()
  @IsMongoId({ message: "Course ID filter must be a valid Mongo ID" })
  courseId?: string;
  ...
  @Field({ nullable: true, description: "Filter by course title snapshot" })
  @IsOptional()
  @IsString({ message: "Course title filter must be a string" })
  courseTitle?: string;
  ...
  @IsOptional()
  @IsEnum(UserCoursePurchaseCurrency, {
...
@InputType()
export class CoursePaymentListGqlInput extends PaginationOffsetInput<CoursePaymentListFilterInput> {
  @Field(() => CoursePaymentListFilterInput, {
    nullable: true,
    description: "Filter options for narrowing down the course payment list",
  })
  @IsOptional()
  @ValidateNested()
  @Type(() => CoursePaymentListFilterInput)
  filters?: CoursePaymentListFilterInput;
